...
class MapNavigationState extends State<MapNavigation> {
  ...
  Future<void> _minus(double zoomVal) async {
    ...
    controller.animateCamera(CameraUpdate.newCameraPosition(CameraPosition(
        target: LatLng(13.199770578307152, 77.69022188791145), zoom: zoomVal)));
  }
        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: _boxes("https://photos.app.goo.gl/rZtE6BDomgcmehQj8",
  ...
  Widget _buildGoogleMap(BuildContext context) {
    ...
    return GoogleMap(
      ...
      initialCameraPosition: CameraPosition(
          target: LatLng(13.199616668128169, 77.70573449308962), zoom: 12),
